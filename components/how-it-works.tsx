...
const content = [
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white">
        <div className="relative flex items-center justify-center w-full h-full">
          ...
          <div className="relative z-10 h-16 w-16 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center shadow-xl">
            <span className="text-2xl font-bold text-white">H</span>
          </div>
          {/* Orbiting Icons */}
          <div className="absolute top-1/4 left-1/4 p-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 shadow-sm animate-bounce-slow">
            <GitBranch className="h-5 w-5 text-white" />
          </div>
          <div className="absolute bottom-1/4 right-1/4 p-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 shadow-sm animate-bounce-slow delay-100">
            <Slack className="h-5 w-5 text-white" />
          </div>
          <div className="absolute top-1/3 right-1/3 p-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 shadow-sm animate-bounce-slow delay-200">
    ...
    content: (
      <div className="h-full w-full p-6 flex flex-col justify-center text-white">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm font-medium text-white/80">Project Health</span>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-3 bg-white/10 rounded-lg backdrop-blur-sm">
            ...
            <div className="text-[10px] text-white/60">Active PRs</div>
          </div>
          <div className="p-3 bg-white/10 rounded-lg backdrop-blur-sm">
            <GitBranch className="h-5 w-5 text-white mb-2" />
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white p-6">
        <div className="relative w-full">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/10 shadow-lg p-6 overflow-hidden">
            <div className="h-24 w-full flex items-end gap-2">
              <div className="w-6 h-[40%] bg-white/20 rounded-t-sm" />
              <div className="w-6 h-[60%] bg-white/40 rounded-t-sm" />
              <div className="w-6 h-[50%] bg-white/30 rounded-t-sm" />
              <div className="w-6 h-[80%] bg-white/60 rounded-t-sm" />
  ...
  },
  {
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white p-6">
        <div className="w-full bg-white/10 backdrop-blur-md rounded-xl border border-white/10 shadow-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-white/60">Re-balance workload for Sprint 4.</p>
            </div>
          </div>
          <div className="mt-4 flex gap-2">
            <button className="flex-1 bg-white text-black text-[10px] font-bold py-2 rounded-lg hover:bg-white/90 transition-colors">
              Auto-Fix
            </button>
          </div>
        </div>
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white">
        <div className="relative flex flex-col items-center justify-center">
          <TrendingUp className="h-32 w-32 text-white/10 absolute" strokeWidth={1} />
          <div className="relative z-20 bg-white/10 backdrop-blur-md border border-white/10 shadow-xl rounded-2xl p-6 text-center space-y-2">
